import { ArrowRight, ArrowUpRight, BookOpen, Boxes, Braces, Check, ChevronRight, Code2, Cpu, Download, Layers3, Terminal } from "lucide-react";
...
export function Component(): React.JSX.Element {
  return <>
    ...
    <section className="section final-cta"><div className="shell"><Reveal><div className="final-cta__inner"><div><SectionEyebrow>Crossa ecosystem</SectionEyebrow><h2>See the compiler, artifacts, and consumer examples together.</h2></div><div><Link className="button button--primary" to="/repositories">Explore repositories <ArrowRight size={17} /></Link><a className="text-link" href="https://github.com/crossa-script/Crossa" target="_blank" rel="noreferrer"><GitHubMark size={16} /> Open GitHub <ArrowUpRight size={15} /></a></div></div></Reveal></div></section>
  </>;
}
